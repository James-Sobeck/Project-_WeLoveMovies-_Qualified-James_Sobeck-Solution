...
const asyncError = require("../utils/errors/asyncError");
...
module.exports = {
  ...
  read: [asyncError(_paramsCheck), read],
  put: [asyncError(_paramsCheck), _bodyCheck, asyncError(put)],
  delete: [asyncError(_paramsCheck), asyncError(destroy)],
};